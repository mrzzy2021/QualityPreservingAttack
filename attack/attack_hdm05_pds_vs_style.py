...
def train_attack_method(classifier_model):
    ...
    for ori_motion, model_kwargs in data:
        ...
        diffusion.our_attack_hdm05(
            ...
            save_path=f'./save/ours_hdm05_100style'
        )
...
if __name__ == "__main__":
    ...
    model_path = "./save/style_classifier_on_hdm05/200.pt"
    tmp_model = torch.load(model_path, map_location='cuda:0')
    victim_model = StyleClassification(65, latent_dim=[1, 64], ff_size=256, skel_embedding_indim=75)
