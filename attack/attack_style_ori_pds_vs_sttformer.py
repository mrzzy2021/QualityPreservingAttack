...
def train_attack_method(victim_model):
    ...
    for ori_motion, model_kwargs in data:
        ...
        diffusion.our_attack_100style(
            ...
            save_path=f'./save/ours_100style_sttformer'
        )
...
if __name__ == '__main__':
    ...
    model_path = "./save/sttformer_classifier_on_100style/200.pt"
    model_args = {'len_parts': 6, 'num_frames': 60, 'num_joints': 23, 'num_classes': 100, 'num_heads': 3,
                  'kernel_size': [3, 5],
